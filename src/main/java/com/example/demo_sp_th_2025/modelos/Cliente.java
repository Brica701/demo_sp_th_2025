...
public class Cliente {
    ...
    private Integer categoria; // Puede ser null, por eso Integer y no int

    // Constructor vacío
    public Cliente() {}

    public Cliente(String nombre, String apellido1, String apellido2, String ciudad, Integer categoria) {
        this.nombre = nombre;
